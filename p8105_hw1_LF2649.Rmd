...
Write a short description of the penguins dataset (not the penguins_raw dataset) using inline R code, including:
  ...
  * the size of the dataset (using nrow and ncol): 
    * There are totally `r ncol(penguins)` variables and `r nrow(penguins)` penguins/ sunjucts have been recorded. 
  * the mean of flipper length is `r mean(as.numeric(pull(penguins,flipper_length_mm))) ` mm. 
